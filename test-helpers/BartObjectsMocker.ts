import {IApiBartStation} from "../src/common/constant/interfaces/bart/Station/IApiBartStation";

export const mockBartStations = {
    "?xml": {"@version": "1.0", "@encoding": "utf-8"},
    "root": {
        "uri": {"#cdata-section": "http://api.bart.gov/api/stn.aspx?cmd=stns&json=y"},
        "stations": {
            "station": [{
...
export const mockApiBartStations: IApiBartStation[] = JSON.parse(JSON.stringify(mockBartStations), (key, val) => {
